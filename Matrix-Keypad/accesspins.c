/*
 * accesspins.c — part of PRJ-FW-4002-2021-COMSATS-AVRMicroprocessorLabs / Matrix-Keypad
 * Copyright (C) 2021 Ibrar Ahmad
 * SPDX-License-Identifier: GPL-3.0-or-later
 *
 * Row/column pin-direction control and raw port reads for the 3x4 keypad
 * scan — provides setcoloutrowin(), setrowoutcolin(), readport(),
 * waitforpress() and waitforrelease() used by readkeypadalgo.c.
 *
