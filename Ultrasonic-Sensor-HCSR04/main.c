/*
 * PRJ-FW-4002-2021-COMSATS-AVRMicroprocessorLabs / Ultrasonic-Sensor-HCSR04
 *
 * Copyright (C) 2021 Ibrar Ahmad
 * SPDX-License-Identifier: GPL-3.0-or-later
 *
 * Interfaces an HC-SR04 ultrasonic distance sensor with an ATmega328P
 * (trigger/echo on PORTC0/PORTC1), measures distance via a Timer1 pulse
 * width capture, and prints it in centimeters to a 16x2 character LCD
 * (bit-banged 4-bit interface on PORTD). Also drives 5 indicator LEDs.
 * Simulated in Proteus 8 Professional.
 *
 * ultrasonic sensor.c
 * Created: 11/29/2021 4:50:54 PM
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////SUBSCRIBE US //////////////////////////////////////////////////////////
///////////////YOUTUBE:- https://www.youtube.com/channel/UCV706NGK4bYrhMHQChhpE-g ///////////////////////
//////////////GITHUBG:- https://github.com/hiibrarahmad /////////////////////////////////////////////////
//////////////GMAIL:- mendupmindcode@gmail.com //////////////////////////////////////////////////////////
/////////////BLOG:- https://mendupmindcode.blogspot.com/ ////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////MENDUPMINDCODE//////////////////////
...
#define rs PD0                  // we need total six pin to show output on the LCD. Data pin 4, 5, 6, and 7 for sending the data to the lcd and Enable and RS pin for controlling
...
//hence i put alot define is just for the use who use atmega32 or atmega 8 or any other arduino so it will be easy for them
