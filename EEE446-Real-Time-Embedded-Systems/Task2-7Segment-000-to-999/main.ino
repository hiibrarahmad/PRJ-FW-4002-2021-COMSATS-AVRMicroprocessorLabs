/*
 * PRJ-FW-4002-2021-COMSATS-AVRMicroprocessorLabs / EEE446-Real-Time-Embedded-Systems / Task2
 * Copyright (C) 2021 Ibrar Ahmad
 * SPDX-License-Identifier: GPL-3.0-or-later
 *
 * Drives three multiplexed 7-segment digits via shift registers
 * (clock/latch/data pins) to count 000-999.
 */
