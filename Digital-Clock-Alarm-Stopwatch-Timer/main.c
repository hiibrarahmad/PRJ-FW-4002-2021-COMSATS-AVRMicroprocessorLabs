/*
 * PRJ-FW-4002-2021-COMSATS-AVRMicroprocessorLabs / Digital-Clock-Alarm-Stopwatch-Timer
 *
 * Copyright (C) 2021 Ibrar Ahmad
 * SPDX-License-Identifier: GPL-3.0-or-later
 *
 * A multi-mode LCD clock: clock/alarm set, stopwatch, and countdown
 * timer, cycled through a menu on a 3-button interface (enter/inc/dec
 * on PORTC0-2), driving a character LCD on PORTB/PORTD. Timer1 CTC
 * interrupt ticks the seconds counter.
 *
 * LCD_alarm_clock.c
 */
