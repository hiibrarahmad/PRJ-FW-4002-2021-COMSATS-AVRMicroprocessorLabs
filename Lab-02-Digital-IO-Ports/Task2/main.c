/*
 * PRJ-FW-4002-2021-COMSATS-AVRMicroprocessorLabs / Lab-02-Digital-IO-Ports / Task2
 *
 * Copyright (C) 2021 Ibrar Ahmad
 * SPDX-License-Identifier: GPL-3.0-or-later
 *
 * Lab 2, Task 2: debounced push-button input (PORTB pin 1) cycles
 * through three LEDs (PORTB0, PORTC1, PORTD2) on each press, one on at
 * a time.
 *
 * LAB2 TASK2.c
